...
<div class="container-fluid">
  <div class="row">
	...
	<div class="col-sm-9 col-md-10 main">
	  <h3 align="center">修改寝室</h3>
	  <hr>
      <form name="form1" method="post" action="DormitoryUpdateSave.action" onSubmit="return mycheck()" >
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="33%" height="30" align="right">&nbsp;</td>
            <td width="67%"><input name="Dormitory_ID" type="text" style="display:none" id="Dormitory_ID" value="<s:property value='cnbean.Dormitory_ID'/>"></td>
          </tr>
<!--           <tr> -->
...
<%--                 <option value="${Building_ID}" <s:if test="cnbean.DB_BuildingID==Building_ID">selected</s:if>>${Building_Name}</option> --%>
<%--               </s:iterator> --%>
<%--             </select></td> --%>
<!--           </tr> -->
          <tr>
            <td height="40" align="right"><span style="color:red;">*</span>寝室号：</td>
            <td><input name="Dormitory_Name" type="text" id="Dormitory_Name" value="<s:property value='cnbean.Dormitory_Name'/>"></td>
          </tr>
          <tr>
            <td height="40" align="right"><span style="color:red;">*</span>寝室大小：</td>
            <td><input name="Dormitory_Size" type="text" id="Dormitory_Size" value="<s:property value='cnbean.Dormitory_Size'/>"></td>
          </tr>
          <tr>
            <td height="50">&nbsp;</td>
