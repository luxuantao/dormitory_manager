...
public class TeacherManager extends ActionSupport {
	...
	private List<TeacherBean> list2 = new ArrayList<TeacherBean>();
	
	public List<TeacherBean> getList2() {
		return list2;
	}
	public void setList2(List<TeacherBean> list2) {
		this.list2 = list2;
	}
	...
	public String execute() throws Exception {
		...
		//查询所有
		list=new TeacherDao().GetList(strWhere,"Teacher_ID");
