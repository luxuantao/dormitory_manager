...
public class BuildingDao {
	...
	public List<BuildingBean> GetList(String strwhere,String strorder){
		...
		try{
			...
			while(rs.next()){
				...
				cnbean.setBuilding_Type(rs.getString("Building_Type"));
				list.add(cnbean);
			}
	...
	public void Add(BuildingBean cnbean){
		...
		sql+="Building_Name,Building_Type";
		sql+=") values(";
		sql+="'"+cnbean.getBuilding_Name()+"','"+cnbean.getBuilding_Type()+"'";
		sql+=")";
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
	...
	public void Update(BuildingBean cnbean){
		...
		sql+="Building_Type='"+cnbean.getBuilding_Type()+"'";
