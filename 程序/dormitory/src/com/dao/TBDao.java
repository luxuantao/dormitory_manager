...
public class TBDao {
	...
	public List<TBBean> GetList(String strwhere, String strorder) {
		String sql="select * from tea_bui,teacher,building "
				+ "where TB_TeacherID=Teacher_ID and TB_BuildingID=Building_ID";
	...
	public void Add(TBBean cnbean){
		String sql="insert into tea_bui (";
	...
	public void Delete(String strwhere){
		String sql="delete from tea_bui where ";
		sql+=strwhere;
		Statement stat = null;
		ResultSet rs = null;
		Connection conn = new DBHelper().getConn();
